...
The reader has read INFRA-1 through INFRA-8 (or OPSDB-1 alone for the intuition, then the structural papers as needed). They understand the architecture. They want to build it. They need to know where to put the first commit.
